 ...
 * @author Uri Boness
 */
public interface SearchResultProcessor extends Plugin {

    void process(SearchContext context, Document document, SearchResult result);

    void postProcess(SearchContext context, SearchResult result);

...
public interface SearchManager {
    ...
    void search(AsyncCallback<SearchResult> callback);

    void search(SearchContext context, AsyncCallback<SearchResult> callback);

    SearchContext getCurrentSearchContext();
}

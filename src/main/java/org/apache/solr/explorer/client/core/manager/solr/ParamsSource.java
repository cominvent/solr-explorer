...
package org.apache.solr.explorer.client.core.manager.solr;
 ...
 * @author Uri Boness
 */
public interface ParamsSource<T extends Context> extends Plugin {

    String getName();

    Class<T> getContextClass();

    void addParams(RequestParams params, T context);

    void addParams(RequestParams params, T context, Properties hints);

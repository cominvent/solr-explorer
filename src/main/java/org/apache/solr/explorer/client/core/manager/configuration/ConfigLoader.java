...
public interface ConfigLoader extends Plugin {
    ...
    boolean load(Element coreElement, SolrCoreConfiguration configuration);

    void postProcess(SolrCoreConfiguration configuration);

    void verify(Verification verification, SolrCoreConfiguration configuration, Schema schema);
